...
export const projects: Project[] = [
  {
    ...
    category: "deporte",
    type: "photo",
    cover: "/projects/coolangatta-gold.jpg",
    coverAlt: "Atletas de surf lifesaving celebrando en el Coolangatta Gold",
  ...
  },
  {
    ...
    category: "deporte",
    type: "video",
    cover: "/projects/get-motivated.jpg",
    coverAlt: "Jugador de fútbol en acción dominando el balón",
  ...
  },
  {
    ...
    type: "video",
    cover: "/projects/country-club.jpg",
    coverAlt: "Cóctel de autor servido en un bar",
  ...
  },
  {
    ...
    category: "gastronomia",
    type: "photo",
    cover: "/projects/fu-ma-chi.jpg",
    coverAlt: "Plato de fideos asiáticos con camarones y vegetales",
