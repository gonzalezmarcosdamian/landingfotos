 ...
 * La grilla carga con un skeleton (Suspense) para mejor sensación de velocidad.
 */
    ...
    <div className="sfv-dash">
      <div className="sfv-dash__top">
        <div>
          ...
          <p className="sfv-dash__sub">Todas tus fotos y videos. Tocá uno para editarlo.</p>
        </div>
        <Link className="sfv-btn sfv-btn--primary" href="/admin/collections/media/create">
          + Subir foto o video
        </Link>
      ...
      <Suspense fallback={<GridSkeleton media />}>
        <MediaGrid />
      </Suspense>
    </div>
  );
